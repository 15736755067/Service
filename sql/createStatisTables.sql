CREATE TABLE `AdConversionsStatis` (
  ...
  `PostbackTimestamp` bigint(22) DEFAULT NULL COMMENT 'unix时间戳，精确到毫秒',
  `VisitTimestamp` bigint(22) DEFAULT NULL COMMENT 'unix时间戳，精确到毫秒',
  `ExternalID` varchar(255) DEFAULT 'Unknown' COMMENT 'External ID',
  `ClickID` varchar(36) DEFAULT '' COMMENT 'ClickID',
  `TransactionID` varchar(255) DEFAULT 'Unknown' COMMENT 'Transaction ID',
  ...
  `CountryCode` varchar(3) DEFAULT '' COMMENT 'Country Code like USA',
  ...
  `VisitorIP` varchar(40) DEFAULT '' COMMENT 'Visitor IP, 如158.69.104.15',
...
CREATE TABLE `AdIPStatis` (
  ...
  `Timestamp` bigint(22) DEFAULT 0 COMMENT 'unix时间戳，精确到小时，补0到毫秒位，如1483869600000',
  `CampaignID` int(11) DEFAULT 0 COMMENT 'Campaign的ID',
...
CREATE TABLE `AdStatis` (
  ...
  `V9` varchar(255) DEFAULT '',
  `V10` varchar(255) DEFAULT '',
  `tsCampaignId` varchar(256) NOT NULL DEFAULT '' COMMENT 'TrafficSource的Campaign',
  `tsWebsiteId` varchar(256) NOT NULL DEFAULT '' COMMENT 'TrafficSource的webset',
